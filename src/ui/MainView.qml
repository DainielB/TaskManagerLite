    ...
    Loader {
        ...
        sourceComponent: Component {
            CreateTaskView {
                id: newTaskDialog
                is_modal: true
                onAccepted: app_controller.task_table_controller.add_new_task(app_controller.project_list_controller.selected_project_id, newTaskDialog.name, newTaskDialog.endDate, newTaskDialog.priority.currentValue, newTaskDialog.kind.currentText, newTaskDialog.status.currentText, newTaskDialog.description)
